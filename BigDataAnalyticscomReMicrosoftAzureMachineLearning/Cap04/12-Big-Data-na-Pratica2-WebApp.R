...
dataset1 <- read.csv(".arquivos_DSA/datasets_limpos/dataset1.csv")
...
dataset1$X..of.Subscribers.Q4.2021..Estimate. <-
    ...
    # gsub() substitui as vírgulas por nada
...
# Carrega o dataset 2, 3 e 6
genre <- read.csv(".arquivos_DSA/datasets_limpos/dataset2.csv")
tree <- read.csv(".arquivos_DSA/datasets_limpos/dataset3.csv")
countries <- read.csv(".arquivos_DSA/datasets_limpos/dataset6.csv")
